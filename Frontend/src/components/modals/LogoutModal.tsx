    ...
    <>
      <Modal open={isOpen} footer={null} closeIcon={null} centered>
        ...
        <div className="flex flex-col items-center gap-5 py-2">
          ...
          <p className="text-center text-base">
            Are you sure you want to log out from Medway?
          </p>
          <div className="flex gap-4 items-center text-sm">
            <button
              onClick={closeModal}
              className="border border-blue-600 bg-blue-600 text-white px-5 py-2 rounded-lg"
            >
              Cancel
            </button>
            <button
              onClick={handleConfirm}
              className="border border-red-500 text-red-500 hover:bg-red-500 hover:text-white px-5 py-2 rounded-lg"
            >
              Confirm
            </button>
          </div>
      ...
      <Modal open={showConfirmModal} footer={null} closable={false} centered>
        <div className="text-center py-6">
          ...
          <p className="text-sm text-gray-500">Redirecting to public dashboard...</p>
        </div>
      </Modal>
    </>
  );
